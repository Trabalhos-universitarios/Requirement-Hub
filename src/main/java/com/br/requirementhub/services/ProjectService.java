...
//        dto.setCommonUser(project.getCommonUser());
    ...
    private Project convertToEntity(ProjectRequestDTO dto) throws IOException {
        ...
        project.setName(dto.getNameProject());
        project.setManager(dto.getNameProjectManager());
        project.setStatus(dto.getStatus());
        project.setRequirementsAnalyst(dto.getNameRequirementAnalyst());
        project.setBusinessAnalyst(dto.getNameBusinessAnalyst());
        project.setCommonUser(dto.getNameCommonUser());
